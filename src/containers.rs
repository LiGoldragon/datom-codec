...
impl Conceivable<Datom> for Text {
    ...
    fn conceive(&self) -> Result<protos::Situated<Datom>, Self::Fault> {
        ...
        Ok(Situated(Situation { extent: protos::Extent(0, 0), children: vec![] }, datom))
    }
}
...
impl Conceivable<Datom> for Meaning {
    ...
    fn conceive(&self) -> Result<protos::Situated<Datom>, Self::Fault> {
        ...
        Ok(Situated(Situation { extent: protos::Extent(0, 0), children: vec![] }, Datom::Meaning(text.clone())))
    }
}
...
impl<T: Datomic> Conceivable<Datom> for Vec<T> {
    ...
    fn conceive(&self) -> Result<protos::Situated<Datom>, Self::Fault> {
        ...
        Ok(Situated(Situation { extent: protos::Extent(0, 0), children: vec![] }, Datom::Vector(values)))
    }
}
