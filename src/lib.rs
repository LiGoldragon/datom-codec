...
pub use anatomy::{Datom, Expected, Fault, Found, IncorporationBudget, Locus, Meaning, Potential, Problem};
...
pub use protos::{
    ...
    Route, Separator, Situated, Situating, Situation, Symbol, Text, Texted, Textualizable, Word,
};
