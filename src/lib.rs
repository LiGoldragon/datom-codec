...
pub use datom::{
    ...
    EvidencedTextualizing, Group, InterimNote, InterimNoteText, PathLock, PathLockText, Projected,
    ProjectionViewing, RealizationViewing, Realized, Report, ReportText, TagList, Text,
};
